...
//The stock span problem is a financial problem where we have a series of n daily price quotes for a stock and we need to calculate the span of
// stocks price for all n days.
//The span Si of the stocks price on a given day i is defined as the maximum number of consecutive days just before the given day, for which the
// price of the stock on the given day is less than or equal to its price on the current day.
...
public class StockSpan {
    ...
    private static int[] stock(int[] price, int n) {
        ...
        for (int i = 1; i < n; i++) {
            ...
            //else , top of stack will have the index of that price which is bigger than the current price
            else {
