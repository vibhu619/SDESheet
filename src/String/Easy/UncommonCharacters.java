...
public class UncommonCharacters {
    public static void main(String[] args) {
        ...
        //else if not present in map, mean not a common element hence add to result string and also make sure to add this character in map to avoid duplicate in result string
