    ...
    private static String removeDuplicate(String str) {
        ...
        while(i<str.length()){
            ...
            if(!stack.empty() && stack.peek()==str.charAt(i)){
                // Remove consecutive characters equal to the top of the stack. If top of stack and current char of str are equal move index till char is not same as top of stac
